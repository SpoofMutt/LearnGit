/*
	...
	5/11/10, integrating changes by Dude MacAwesome (Eric Gaertner)
...
static char text_array[475] PROGMEM = {0x00,0x00,0x00,0x00,0x00,/*space*/
...
ISR (SIG_USART_RECV)//USART Receive Interrupt
{
	...
	// This prevents the case when a multi-byte command was split
	// across the tail and head of the buffer, causing part of it to
	// be lost, since there isn't a well implemented ring buffer here.
	//
