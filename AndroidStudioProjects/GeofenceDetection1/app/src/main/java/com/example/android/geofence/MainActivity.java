...
public class MainActivity extends FragmentActivity {
    ...
    public class GeofenceSampleReceiver extends BroadcastReceiver {
        ...
        private void handleGeofenceTransition(Context context, Intent intent) {
             ...
             */
            // Check the action code and determine what to do
            String action = String.format("Transition() %s",intent.getAction().toString());
            Log.d(GeofenceUtils.APPTAG,action);
            Toast.makeText(context, action, Toast.LENGTH_SHORT).show();
        }
        ...
        private void handleGeofenceError(Context context, Intent intent) {
            String action = String.format("Error() %s",intent.getStringExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS));
            Log.e(GeofenceUtils.APPTAG, action);
